<x-app-layout>
    ...
    <div class="py-6 {{ $themeBg }} min-h-full font-sans antialiased text-[#1e293b]">
                    ...
                    @if(!$isMaster)
                        <form action="{{ route('tasks.store') }}" method="POST" class="space-y-4">
                            ...
                            <div>
                                ...
                                <select name="category_id" required class="w-full text-sm border-gray-200 rounded-xl shadow-sm focus:border-[#1862ff] focus:ring-1 focus:ring-[#1862ff] px-4 py-2.5 bg-white">
                            ...
                            <div class="border-t border-gray-100 pt-3 space-y-3">
                                <div>
                                    ...
                                    <select name="project_id" id="project_select" class="w-full text-sm border-gray-200 rounded-xl shadow-sm focus:border-[#1862ff] focus:ring-1 focus:ring-[#1862ff] px-4 py-2.5 bg-white">
                                ...
                                <div id="new_project_field" class="hidden">
                                    ...
                                    <input type="text" name="new_project_name" id="new_project_name" class="w-full text-sm border-blue-200 rounded-xl focus:ring-1 focus:ring-blue-500 px-4 py-2.5" placeholder="Nom du projet...">
                                </div>

                                <div>
                                    <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">Étape liée</label>
                                    <select name="project_step_id" id="step_select" class="w-full text-sm border-gray-200 rounded-xl shadow-sm focus:border-[#1862ff] focus:ring-1 focus:ring-[#1862ff] px-4 py-2.5 bg-white">
                                ...
                                <div id="new_step_field" class="hidden">
                                    ...
                                    <input type="text" name="new_step_name" id="new_step_name" class="w-full text-sm border-blue-200 rounded-xl focus:ring-1 focus:ring-blue-500 px-4 py-2.5" placeholder="Nom de l'étape...">
                                </div>
                            </div>
                            ...
                            <div class="border-t border-gray-100 pt-3 space-y-3">
                                <div>
                                    ...
                                    <select name="document_status" class="w-full text-sm border-gray-200 rounded-xl shadow-sm focus:border-[#1862ff] focus:ring-1 focus:ring-[#1862ff] px-4 py-2.5 bg-white">
