...
<head>
    ...
    <!-- Style x-cloak pour éviter que les éléments cachés ne clignotent au chargement -->
    <style>
            ...
            <aside x-show="sidebarOpen" 
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex items-center justify-between pb-3 border-b border-gray-100">
                        ...
                        <button @click="sidebarOpen = false" type="button" class="text-gray-400 hover:text-gray-600 text-xs flex items-center gap-1">
                            ✕ Masquer
                        </button>
                    </div>
                    ...
                    <nav class="space-y-1">
                        <a href="{{ route('dashboard', ['view' => 'dashboard']) }}" 
                           class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-semibold {{ request('view', 'dashboard') === 'dashboard' ? 'bg-blue-50 text-[#0052cc]' : 'text-gray-600 hover:bg-gray-50' }}">
                            📊 <span>Dashboard</span>
                        </a>
                    </nav>
                    ...
                    <div class="space-y-2 pt-2 border-t border-gray-100">
                        ...
                        <a href="{{ route('dashboard', ['view' => 'office']) }}" 
                           class="flex items-center justify-between px-3 py-2 rounded-lg text-sm font-medium transition-colors {{ request('view') === 'office' ? 'bg-gray-100 font-bold text-gray-900 border border-gray-200' : 'text-gray-600 hover:bg-gray-50' }}">
                        ...
                        <a href="{{ route('dashboard', ['view' => 'master']) }}" 
                           class="flex items-center justify-between px-3 py-2 rounded-lg text-sm font-medium transition-colors {{ request('view') === 'master' ? 'bg-gray-100 font-bold text-gray-900 border border-gray-200' : 'text-gray-600 hover:bg-gray-50' }}">
